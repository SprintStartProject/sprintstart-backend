...
class JiraDisplayNameServiceTest {
    ...
    /**
     * Not lower-cased, unlike a GitHub login. A GitHub login is case-insensitive at the
    ...
    /**
     * Sharper than the GitHub case. A wrong GitHub login silently credits a hire with nothing;
