...
class ArtifactIngestionApiServiceTest {
    ...
    /**
     * Mining skips an assigned issue because proposing somebody else's work is a wrong answer a
    ...
    /**
     * A blank assignee name must match nobody, and the guard belongs here rather than in the
