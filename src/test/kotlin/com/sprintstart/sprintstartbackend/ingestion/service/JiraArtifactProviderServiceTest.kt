...
/**
 * What this fixes failed silently. Starter-work mining's candidate filter is
...
class JiraArtifactProviderServiceTest {
    ...
    /**
     * A definite `false`, not null. Jira's assignee field *is* ingested, so an unassigned
    ...
    /**
     * Refreshed on re-ingest unconditionally, like GitHub's. A ticket moving to Done shifts
