...
class BlueprintGraphControllerTest : BlueprintControllerTestSupport() {
    ...
    override val controller = BlueprintGraphController(service)
    override val controllerClass = BlueprintGraphController::class
    ...
    override val endpointCases =
        listOf(
            EndpointCase(
                ...
                request =
                    post("/api/v1/projects/$projectId/onboarding/blueprint/graph-nodes/$nodeId/blockers/$blockerId")
            ...
            EndpointCase(
                ...
                request =
                    put("/api/v1/projects/$projectId/onboarding/blueprint/graph-nodes/$nodeId/position")
                        .contentType(MediaType.APPLICATION_JSON)
            ...
            EndpointCase(
                ...
                request =
                    delete("/api/v1/projects/$projectId/onboarding/blueprint/graph-nodes/$nodeId/blockers/$blockerId")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""{"revision":0}"""),
                expectedStatus = 200,
            ...
            EndpointCase(
                ...
                request =
                    delete("/api/v1/projects/$projectId/onboarding/blueprint/graph-nodes/$nodeId/position")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""{"revision":0}"""),
                expectedStatus = 200,
