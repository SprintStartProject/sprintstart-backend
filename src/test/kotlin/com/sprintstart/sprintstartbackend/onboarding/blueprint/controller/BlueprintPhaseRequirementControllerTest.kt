...
class BlueprintPhaseRequirementControllerTest : BlueprintControllerTestSupport() {
    ...
    override val controller = BlueprintPhaseRequirementController(service)
    override val controllerClass = BlueprintPhaseRequirementController::class
    ...
    override val endpointCases =
        listOf(
            EndpointCase(
                ...
                request =
                    post("/api/v1/projects/$projectId/onboarding/blueprints/phases/$phaseId/requirements")
            ...
            EndpointCase(
                ...
                request =
                    delete("/api/v1/projects/$projectId/onboarding/blueprints/phases/$phaseId/requirements")
                        .contentType(MediaType.APPLICATION_JSON)
