...
class BlueprintResourceAdminControllerTest : BlueprintControllerTestSupport() {
    ...
    override val controller = BlueprintResourceAdminController(service)
    override val controllerClass = BlueprintResourceAdminController::class

    override val endpointCases =
        listOf(
            EndpointCase(
                name = "GET /step/{stepId}/resources",
                request = get("/api/v1/onboarding/blueprints/step/$stepId/resources"),
                expectedStatus = 200,
                response = listOf(resourceResponse),
                serviceCall = {
                    service.getBlueprintResourcesForStep(BlueprintScope.Global, stepId)
                },
                documentsNotFound = false,
            ),
            EndpointCase(
                name = "GET /resources/{resourceId}",
                request = get("/api/v1/onboarding/blueprints/resources/$resourceId"),
                expectedStatus = 200,
            ...
            EndpointCase(
                ...
                request =
                    post("/api/v1/onboarding/blueprints/step/$stepId/resources")
                ...
                serviceCall = {
                    service.createBlueprintResourceForStep(BlueprintScope.Global, stepId, createBody)
                },
            ...
            EndpointCase(
                ...
                request =
                    put("/api/v1/onboarding/blueprints/resources/$resourceId")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(
                ...
                serviceCall = {
                    service.updateBlueprintResourceById(BlueprintScope.Global, resourceId, updateBody)
                },
                documentsConflict = true,
            ),
            EndpointCase(
                ...
                request =
                    delete("/api/v1/onboarding/blueprints/resources/$resourceId")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""{"revision":0}"""),
                expectedStatus = 204,
                response = null,
                serviceCall = {
                    service.deleteBlueprintResourceById(BlueprintScope.Global, resourceId, deleteBody)
                },
                documentsConflict = true,
            ),
        )
