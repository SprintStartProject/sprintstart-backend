...
class BlueprintSubGraphControllerTest : BlueprintControllerTestSupport() {
    ...
    override val controller = BlueprintSubGraphController(service)
    override val controllerClass = BlueprintSubGraphController::class
    ...
    override val endpointCases =
        listOf(
            EndpointCase(
                ...
                request =
                    post(
                        "/api/v1/projects/$projectId/onboarding/blueprints/sub-graph-nodes/$nodeId/blockers/$blockerId",
            ...
            EndpointCase(
                ...
                request =
                    put("/api/v1/projects/$projectId/onboarding/blueprints/sub-graph-nodes/$nodeId/position")
                        .contentType(MediaType.APPLICATION_JSON)
            ...
            EndpointCase(
                ...
                request =
                    delete("/api/v1/projects/$projectId/onboarding/blueprints/sub-graph-nodes/$nodeId/position")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""{"revision":0}"""),
                expectedStatus = 200,
