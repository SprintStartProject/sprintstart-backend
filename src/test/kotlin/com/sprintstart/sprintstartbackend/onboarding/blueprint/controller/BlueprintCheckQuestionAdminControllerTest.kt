...
class BlueprintCheckQuestionAdminControllerTest : BlueprintControllerTestSupport() {
    ...
    override val controller = BlueprintCheckQuestionAdminController(service)
    override val controllerClass = BlueprintCheckQuestionAdminController::class
    ...
    override val endpointCases =
        listOf(
            EndpointCase(
                ...
                request =
                    get("/api/v1/onboarding/blueprints/phase/$phaseId/checks/questions"),
                expectedStatus = 200,
            ...
            EndpointCase(
                ...
                request =
                    get("/api/v1/onboarding/blueprints/checks/questions/$questionId"),
                expectedStatus = 200,
                response =
            ...
            EndpointCase(
                ...
                request =
                    post("/api/v1/onboarding/blueprints/phase/$phaseId/checks/questions")
            ...
            EndpointCase(
                ...
                request =
                    put("/api/v1/onboarding/blueprints/checks/question/$questionId")
                        .contentType(MediaType.APPLICATION_JSON)
            ...
            EndpointCase(
                ...
                request =
                    put("/api/v1/onboarding/blueprints/checks/question/$questionId/position")
                        .contentType(MediaType.APPLICATION_JSON)
            ...
            EndpointCase(
                ...
                request =
                    delete("/api/v1/onboarding/blueprints/checks/question/$questionId")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""{"revision":0}"""),
                expectedStatus = 200,
