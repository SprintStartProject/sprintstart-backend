...
data class IngestionRunResponse(
    ...
    @field:Schema(description = "Number of new canonical artifacts created during the run.")
    val ingestedCount: Int = 0,
    @field:Schema(description = "Number of existing canonical artifacts updated during the run.")
