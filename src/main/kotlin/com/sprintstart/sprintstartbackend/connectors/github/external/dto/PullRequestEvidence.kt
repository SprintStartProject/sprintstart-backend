...
data class PullRequestEvidence(
     ...
     *
     * Without this the judge could only see filenames, which cannot tell a real fix from a
     ...
     *
     * Load-bearing, not a statistic. A judge shown a partial diff and not told it is partial
