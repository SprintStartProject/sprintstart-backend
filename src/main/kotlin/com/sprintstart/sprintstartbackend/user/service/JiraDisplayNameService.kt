 ...
 *
 * Not lower-cased, unlike a GitHub login: this is a person's name, matched against what
 * Jira renders, so folding case would both misspell somebody and stop matching.
 *
 * No syntax rule. Anything Jira renders is a valid display name; a pattern would reject real
 * people for looking wrong to a regex.
 *
 * It cannot defend against a namesake inside Jira. Uniqueness here means no two *SprintStart
