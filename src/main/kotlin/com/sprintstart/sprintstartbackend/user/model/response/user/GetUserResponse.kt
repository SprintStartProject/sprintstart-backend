...
data class GetUserResponse(
    ...
    val enabled: Boolean,
    /**
     * Whether this person has been through onboarding once.
     *
     * Set on the first sign-in that resolves a project and never unset. Retained because
     * upstream's own onboarding surface reads it; the buddy does not.
     */
