 ...
 * collector is ready.
 *
 * Expects standard SSE lines (`data: <payload>`); ⚠️ lines not starting with `data:` (comments,
 * blank keep-alives) are silently skipped.
 *
 * A non-2xx status before the stream starts throws [WebClientException]. ⚠️ Per-chunk
