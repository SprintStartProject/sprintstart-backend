 ...
 *
 * Never uncited. An ungrounded node is dropped by the AI service before it is returned: no kind of
 * node is exempt, because every box asserts that this project contains this part.
 */
@Serializable
