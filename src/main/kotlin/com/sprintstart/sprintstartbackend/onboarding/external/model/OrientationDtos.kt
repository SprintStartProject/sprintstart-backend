 ...
 *
 * Every section carries the chunks it was assembled from, and no kind is exempt: a packet section
 * that cites nothing has already been dropped by the AI service, so an empty [citations] list here
 * means something went wrong upstream, not that the section is fine.
 */
@Serializable
