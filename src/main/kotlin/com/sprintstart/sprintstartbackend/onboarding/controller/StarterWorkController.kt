...
//  ========================== Endpoints for admins ==========================
     ...
     *
     * Mined tasks are stored `LIVE`, one row per issue, and are claimable immediately. Nothing
     ...
     *
     * Not a queue and not a shortlist. Nothing here has been judged and nothing is waiting on
     ...
     * task written in the blank form lands. This adds a way in; it gates nothing.
     */
    @Operation(
     ...
     *
     * Not a queue anything waits in. These tasks are already claimable — mining lands them
     ...
     *
     * This admits nothing. It was claimable before and it is claimable after; what changes
     * is that `StarterWorkMatcher` stops demoting it for being unvouched. It is deliberately
